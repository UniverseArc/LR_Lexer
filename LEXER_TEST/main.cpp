                ...
                args.c_u.are_equal(parseResult,
                    ParseResult{
                        Location{ 7, 0 },
                        {
                          ...
                          ParseItem{Token{"1", TermTypes::TRUE}, StatusCodes::SUCCESS__ },
                ...
                args.c_u.are_equal(parseResult,
                    ParseResult{
                        Location{ 7, 0 },
                        {
                          ParseItem{Token{"A", TermTypes::IDENTIFIER}, StatusCodes::SUCCESS__},
                          ParseItem{Token{":=", TermTypes::ASSIGNMENT}, StatusCodes::SUCCESS__},
                          ParseItem{Token{"0", TermTypes::TRUE}, StatusCodes::SUCCESS__ },
                          ParseItem{Token{ ";", TermTypes::SEMICOLON }, StatusCodes::SUCCESS__}
                        },
                        false
                    }
                ...
                args.c_u.are_equal(parseResult,
                    ParseResult(
                        Location(12, 0),
                        {
                          ...
                          ParseItem(Token("0", TermTypes::FALSE), StatusCodes::SUCCESS__),
                          ParseItem(Token(";", TermTypes::SEMICOLON), StatusCodes::SUCCESS__)
                        },
                        false
                    )
